...
import { Visit, getVisitShortLocation } from "../lib/supabase";
...
const VisitCard: React.FC<VisitCardProps> = ({
  ...
  // Keep structure: wrapper that now delegates to shared helper
  ...
  const getVitalStatus = () => {
    ...
    if (visit.blood_sugar && visit.blood_sugar > 180)
      issues.push("High Blood Sugar");
        ...
        <Card.Content style={styles.content}>
          ...
          {showPatientInfo && visit.patients && (
            <View style={styles.personInfo}>
              ...
              <Text style={styles.personName}>
                {visit.patients.name} ({visit.patients.age}y,{" "}
          ...
          {showDoctorInfo && visit.field_doctors && (
            <View style={styles.personInfo}>
              ...
              <Text style={styles.personName}>
                Dr. {visit.field_doctors.name} •{" "}
                {visit.field_doctors.specialization}
              </Text>
            </View>
          )}
